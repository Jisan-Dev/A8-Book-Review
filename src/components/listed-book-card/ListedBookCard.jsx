...
const ListedBookCard = ({ book }) => {
  return (
    <div className="p-6 flex gap-6 border rounded-2xl mb-6">
      <div className="bg-neutral-900 bg-opacity-5 rounded-2xl flex items-center justify-center w-[230px]">
      ...
      <div>
        ...
        <div className="border-t border-neutral-900 border-opacity-20 pt-5 mt-5">
